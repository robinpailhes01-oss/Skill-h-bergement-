...
| Site | TTFB / FCP / load (home desktop) | Requêtes / poids | Vidéos | Lazy / srcset / alt / focus | H1 | Méta / SEO |
|---|---|---|---|---|---|---|
| Hotel Odisej | 1 035 ms / 3,1 s / — ; wellness TTFB 4,6 s | 84 / 5,9 Mo (images 3,9 Mo) ; contact 6,4 Mo (PNG 2,6 Mo, 74 requêtes Maps) | aucune | 3/28 lazy ; 0 srcset ; hero mobile 600×400 upscalé ; 47–69 sans focus ; hamburger sans nom | 0 sur la home | 0 hreflang malgré /hr/ ; JSON-LD sans Hotel ; 28–174 mots/page |
| Mas Girbau | 1 128 ms / 2,1 s / 8,5 s ; mobile FCP 1,7 s | 401 / 104,5 Mo ; mobile 206 / 69 Mo ; galerie 56,5 Mo | 7 autoplay (hero 22,3 + 18,2 Mo) | 0 srcset ; 119/121 alt vides ; 81 sans focus ; 167 aria-hidden | 9 | hreflang es/ca/en ; 0 canonical, 0 JSON-LD |
| Our Habitas | 1 010 ms / 2,3 s / 8,2 s | 559 / 26,5 Mo ; CSS 2,3 Mo ; HTML 1,9 Mo ; Films 1 907 req / 159 Mo ; mobile 300 / 14,7 Mo | Vimeo hero | 44 alt vides (Rooms) ; ≥ 200 sans focus ; BOOK mobile 48×20 ; `lang` inversé | 0 | JSON-LD WebPage ; lien staging |
| Aethos | — / 1,7 s / 6,7 s ; Ericeira 14,9 s ; club FCP 3,2 s ; mobile FCP 1,1 s | 399 / 38,8 Mo ; Ericeira 457 / 42,5 Mo ; mobile 197 / 11 Mo | Vimeo 13,2 Mo de segments desktop, 0 mobile | JPEG 3 Mo sur 5 pages ; 124–200 sans focus ; 68–144 liens sans nom ; 49/51 alt vides | 1 | canonical, og ; 0 hreflang (Weglot 5 langues) ; 0 JSON-LD |
| White Desert | 0,2–11,9 s / 1,4 s / 6,4 s ; mobile FCP 0,66 s | 462 / 43,9 Mo (media 19,8) ; mobile 175 / 15,2 Mo ; Echo 24,3 Mo / 15,2 s | Cloudflare Stream 4–8 Mo aussi mobile | alt complets ; 69–106 sans focus ; labels absents ; 7 trackers | 1 partout | titles/descriptions propres ; JSON-LD Organization seul ; 0 hreflang |
| Explora Journeys | 306 ms / 0,6 s / — ; mobile FCP 2,1 s | 366 / 89 Mo ; suites 440 Mo / 24,8 s ; globe 707 req / 108 Mo ; mobile 205 / 46 Mo | 4 home (4–15 Mo), suites 82 + 31 Mo ; `preload="none"` + `#t=0.001` mobile | 0 srcset ; 1 lazy ; 37 alt manquants ; 200 sans focus ; zoom bloqué ; accessiBe | 0 (home), 4 (Dining) | 45 hreflang ; JSON-LD Organization + Breadcrumb ; contact → home |
| Experimental Group | 231–712 ms / 0,9–3,7 s ; Val d'Isère 10,3 s | 552 / 73 Mo ; explore-hotels 96 Mo ; mobile 219 / 28,4 Mo | webm + mp4 chargés ensemble, poster vide | alts 100 % ; 200 sans focus ; 12–13 boutons sans nom ; radios sans label | 1 partout | hreflang 5 langues ; JSON-LD Organization / Hotel / Restaurant / CollectionPage |
| Soneva | — / 4,2 s (5,2 s mobile) ; villas load 26,8 s | 668 / 19,2 Mo ; tiers 11 Mo (AdRoll 56 req, TikTok 40) ; mobile 268 / 9 Mo | Gumlet HLS ×4 ; posters | `user-scalable=no` ; 59–200 sans focus ; `main` absent ; points de carrousel 6 px | absent sur resort et contact | hreflang [] ; JSON-LD WebPage / AboutPage |
| Vipp Guesthouses | 0,6–3,5 s / 1,5–6,6 s (1,8–2,1 s mobile) | 65–226 Mo par page ; 106–126 scripts (8,3–10,4 Mo) | 10–13 vidéos `preload="auto"` ; film 29,9 Mo téléchargé 2–3 fois | alt = noms de fichiers ; 0 reduced motion | 0 sur 12 pages | description sur /en seulement ; ni hreflang ni JSON-LD |
| Pelorus Travel | 0,6–2,9 s / 0,9–3,7 s / 3,2–15 s | 339 / 120,9 Mo (vidéo 21,4 Mo ×2, images 66,5 Mo) ; about 176 Mo ; campagne 352 Mo ; mobile 60,7 Mo | vidéo desktop servie en mobile | 0 srcset ; 200 sans focus ; 16 boutons sans nom | 3 | hreflang x-default/en-GB/en-US ; JSON-LD Organization + TravelAgency ; FAQ |

Interprétation série 2 : la médiane passe de ≈ 28 Mo (série 1) à ≈ 65 Mo, avec des pointes à 226 et 440 Mo, presque entièrement dues aux vidéos (plusieurs sources chargées, `preload="auto"`, masters non compressés) et aux scripts marketing (10 Mo). L'accessibilité reste absente sur 15 sites sur 15 (focus supprimé sur 47 à 200 éléments par page, H1 absents, zoom bloqué). Le srcset est absent sur 8 sites sur 10.
